...
## roc_curve.py
# Generates ROC curve using the saved LightGBM model
...
from models.config import TRAIN_PATH, FEATURES, TARGET, SPEED_TO_SCORE, DOG_TYPE
from models.features import add_sentiment_features
...
# 2. LOAD SAVED MODEL
model_path = os.path.join(os.path.dirname(__file__), '..', 'outputs', 'lgb_model.txt')
